...
contract FlashloanV2 is FlashLoanReceiverBaseV2, Withdrawable {
    ...
    function withdrawFromContract(address _asset) public payable onlyOwner {
        uint256 amountBalance = IERC20(_asset).balanceOf(address(this));
        IERC20(_asset).transfer(msg.sender, amountBalance);
    }
